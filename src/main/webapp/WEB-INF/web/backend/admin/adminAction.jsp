						...
						<div class="portlet-body">
								  ...
								  <div class="portlet">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-user-md"></i><c:if test="${doType==\"add\"}"> 添加</c:if><c:if test="${doType==\"edit\"}"> 修改</c:if>
										</div>
						  ...
						  <div class="portlet-body form">
									<form <c:if test="${doType==\"add\"}">action="${ctx}/backendadmin/saveAdmin"</c:if>  <c:if test="${doType==\"edit\"}">action="${ctx}/backendadmin/updateAdmin"</c:if> method="post" id="form_admin" class="form-horizontal">
										<div class="form-body">
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<input type="text" name="userName" data-required="1" class="form-control" value="<c:out value='${admin.userName}'/>" />
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<input type="text" name="realName" data-required="1" class="form-control" value="<c:out value='${admin.realName}'/>" />
												</div>
											</div>
										</div>
...
<%--<script type="text/javascript" src="${ctx}/assets/plugins/jquery.input-ip-address-control-1.0.min.js"></script> --%>
...
<script src="${ctx}/assets/scripts/backend/admin/form-admin-validation.js" ></script>
<!-- 上传文件 -->
...
jQuery(document).ready(function() {   
	...
	$("#menu_2").text("管理员管理");
	   ...
	   $('#cancelBtn').on( 'click', function () {
	       window.location.href = "${ctx}/backendadmin/adminManagement?activeTab=tab_0";
	    } );
