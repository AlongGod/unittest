						...
						<div class="tab-content">
							<div class="tab-pane fade" id="tab_0">
								<!-- BEGIN EXAMPLE TABLE PORTLET-->
								 <jsp:include page="tabs/adminManagement-tab.jsp"></jsp:include> 
...
<script src="${ctx}/assets/scripts/backend/admin/adminManagement-table-ajax.js"></script>
<script>
var oAdminManagementTable;
var activeTab = "${activeTab}";
var adminManagementURL = "${ctx}/backendadmin/queryAdminMap";
jQuery(document).ready(function() {     
	...
	$("#menu_2").text("管理员管理");
    App.init();
    oAdminManagementTable =  AdminTableAjax.init();
    ...
    $("#adminManagement tbody tr").click( function( e ) {
        if ( $(this).hasClass('active') ) {
            $(this).removeClass('active');
        }
        else {
            oAdminManagementTable.$('tr.active').removeClass('active');
            $(this).addClass('active');
        } 
    });

    $('#adminManagement_addBtn').on( 'click', function () {
	       window.location.href = "${ctx}/backendadmin/newAdmin";
	    } );
    $(".dataTables_filter").hide();
});

function editAdmin(queryParams) {
    var arr = queryParams.split(",");
    window.location.href = "${ctx}/backendadmin/getAdmin?id="+arr[0];
}

function deleteAdmin(queryParams) {
   var arr = queryParams.split(",");
                  ...
                  main: {
                   ...
                   success: {
                     ...
                     callback: function() {
                    	    $.ajax({  
				                type : 'POST',  
				                url :"${ctx}/backendadmin/deleteAdmin" ,  
		                        data:{"id" : arr[0]} ,
				                dataType : 'json', 
				                async : false,  //同步
