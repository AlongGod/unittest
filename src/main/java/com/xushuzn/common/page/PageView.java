package com.xushuzn.common.page;
...
public class PageView {
	...
	private String sEcho;// datable专用参数
	...
	public void setClientPageIndex(long pageNow, long pageCount, long pageSize,
			long rowCount) {
		this.pageIndex = WebTool.getClientPageIndex(pageNow, pageCount,
				pageSize, rowCount);
	}
